...
class EventCrudController extends AbstractCrudController
{
    ...
    public function configureCrud(Crud $crud): Crud
    {
        return $crud
            ...
            ->setPageTitle('index', "Listing des évènements")
            ->setPageTitle('new', "Création d'un évènement")
            ->setPageTitle('edit', "Modification d'un évènement")
            ->setFormThemes(
                [
    ...
    public function configureActions(Actions $actions): Actions
    {
        ...
        $linkPage = Action::new('linkPage', 'Voir le rendu')
            ->linkToUrl(function (Article $entity) {
                return $_ENV['ABSOLUTE_URL'] . '/fr/evenements/' . $entity->getPath();
            })
        ...
        return $actions
            ->update(Crud::PAGE_INDEX, Action::NEW, function (Action $action) {
                return $action->setIcon('fa fa-plus me-2')->setLabel("Ajouter un évènement");
            })
    ...
    public function createIndexQueryBuilder(SearchDto $searchDto, EntityDto $entityDto, FieldCollection $fields, FilterCollection $filters): QueryBuilder
    {
        ...
        $response->setParameter("typeArticle", GlobalConstants::ARTICLE_EVENEMENT);
    ...
    {
        $article = new Article();
        $article->setTypeArticle(GlobalConstants::ARTICLE_EVENEMENT);
        ...
        if ($this->requestStack->getCurrentRequest()->query->has('clone')) {
            ...
            if ($articleClone instanceof Article) {
                ...
                $article->setDateEndSchedule($articleClone->getDateEndSchedule());
    ...
    public function configureFields(string $pageName): iterable
    {
        ...
        return [
            ...
            DateTimeField::new('dateSchedule', "Date de l'évènement")->setColumns(3)->setRequired(true),
            DateTimeField::new('dateEndSchedule', "Date de fin l'évènement")->setColumns(3)->setRequired(false),
